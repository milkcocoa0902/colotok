...
abstract class AsyncProvider(
    ...
    private suspend fun publishAutomatically(
    ...
    private suspend fun removePublishedPrefix(
        records: List<LogRecord>,
        reportMetrics: Boolean
    ) {
        mutex.withLock {
...
private fun validateAsyncProviderConfig(config: AsyncProviderConfig): AsyncProviderConfig =
    config.apply {
